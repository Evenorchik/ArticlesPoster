...
Напиши короткий, но детальный промпт на английском языке для генерации обложки. Промпт должен быть визуально привлекательным и отражать суть статьи. Не включай в ответ ничего кроме самого промпта."""
...
# - Среднее качество (standard): ~$0.04 за изображение  
# - Высокое качество (hd): ~$0.17 за изображение
# - Текстовые входные токены: $5 за 1 млн токенов
# - Токены выходных изображений: $40 за 1 млн токенов
